...
const OrderHistoryLists = () => {
  ...
  return (
    <div className="w-full bg-white drop-shadow-md rounded-[16px] p-[32px] mt-[30px] flex flex-col gap-[32px]">
      ...
      <div className="w-full flex flex-col gap-[16px]">
        <div className="flex items-center gap-[16px] flex-wrap">
          ...
          <select name="" id="" className="text-[#b3b3b3] py-[10px] flex items-center gap-[10px] relative cursor-pointer text-[14px] outline-none">
