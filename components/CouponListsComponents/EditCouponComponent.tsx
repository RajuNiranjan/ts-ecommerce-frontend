...
import { disableEditCouponComponentShow } from "@/redux/EditCouponComponentShow";

const EditCouponComponent = () => {
  ...
  return (
    ...
    style={{scrollbarWidth: 'none'}}>
        ...
        onClick={()=>{ dispatch(disableEditCouponComponentShow()) }}>
            <CloseIcon />
        </div>
...
export default EditCouponComponent